...
namespace _22._02._2022 {
    ...
    public partial class CarsDBDataSet : global::System.Data.DataSet {
        ...
        public partial class CarDataTable : global::System.Data.TypedTableBase<CarRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public CarRow AddCarRow(int Id, string Brand, string Model, int Production) {
        ...
        public partial class CarRow : global::System.Data.DataRow {
            ...
            public int Production {
                get {
                    return ((int)(this[this.tableCar.ProductionColumn]));
                }
                set {
                    this[this.tableCar.ProductionColumn] = value;
                }
            }
        }
...
namespace _22._02._2022.CarsDBDataSetTableAdapters {
    ...
    public partial class CarTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Car] WHERE (([Id] = @Original_Id) AND ([Production] = @Origina" +
                "l_Production))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Car] ([Id], [Brand], [Model], [Production]) VALUES (@Id, @Bran" +
                "d, @Model, @Production);\r\nSELECT Id, Brand, Model, Production FROM Car WHERE (Id" +
                " = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Car] SET [Id] = @Id, [Brand] = @Brand, [Model] = @Model, [Productio" +
                "n] = @Production WHERE (([Id] = @Original_Id) AND ([Production] = @Original_Prod" +
                "uction));\r\nSELECT Id, Brand, Model, Production FROM Car WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::_22._02._2022.Properties.Settings.Default.CarsDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Brand, Model, Production FROM dbo.Car";
        ...
        public virtual int Fill(CarsDBDataSet.CarDataTable dataTable) {
        ...
        public virtual CarsDBDataSet.CarDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CarsDBDataSet.CarDataTable dataTable = new CarsDBDataSet.CarDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CarsDBDataSet.CarDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, int Original_Production) {
        ...
        public virtual int Insert(int Id, string Brand, string Model, int Production) {
            ...
            this.Adapter.InsertCommand.Parameters[3].Value = ((int)(Production));
        ...
        public virtual int Update(int Id, string Brand, string Model, int Production, int Original_Id, int Original_Production) {
            ...
            this.Adapter.UpdateCommand.Parameters[3].Value = ((int)(Production));
            this.Adapter.UpdateCommand.Parameters[4].Value = ((int)(Original_Id));
            this.Adapter.UpdateCommand.Parameters[5].Value = ((int)(Original_Production));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Brand, string Model, int Production, int Original_Id, int Original_Production) {
            return this.Update(Original_Id, Brand, Model, Production, Original_Id, Original_Production);
        }
    }
